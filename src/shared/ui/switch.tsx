	...
	return (
		<>
			...
			<SwitchPrimitive.Control
				class={cn(
					`
					inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent bg-neutral-700
				 shadow-sm transition-shadow data-[disabled]:(cursor-not-allowed opacity-50) data-[checked]:bg-brand-default
...
export const SwitchThumb = <T extends ValidComponent = "div">(
	...
	return (
		<SwitchPrimitive.Thumb
			class={cn(
				"pointer-events-none block h-4 w-4 translate-x-0 rounded-full bg-neutral-50 shadow-lg transition-transform data-[checked]:translate-x-4",
				local.class,
			)}
			{...rest}
		/>
